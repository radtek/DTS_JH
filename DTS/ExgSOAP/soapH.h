...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:SetExMailResponse", p->soap_type() == SOAP_TYPE__tempuri__SetExMailResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__SetExMailResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:SetExMail", p->soap_type() == SOAP_TYPE__tempuri__SetExMail ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__SetExMail(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDonTestResponse", p->soap_type() == SOAP_TYPE__tempuri__AnDonTestResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDonTestResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDonTest", p->soap_type() == SOAP_TYPE__tempuri__AnDonTest ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDonTest(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDonCallResponse", p->soap_type() == SOAP_TYPE__tempuri__AnDonCallResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDonCallResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDonCall", p->soap_type() == SOAP_TYPE__tempuri__AnDonCall ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDonCall(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDonResponse", p->soap_type() == SOAP_TYPE__tempuri__AnDonResponse ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDonResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (p->soap_serialize(soap), 0) || p->soap_put(soap, "tempuri:AnDon", p->soap_type() == SOAP_TYPE__tempuri__AnDon ? "" : NULL) || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__tempuri__AnDon(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__SetExMail_(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDonTest_(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDonCall_(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDon_(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__SetExMail(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDonTest(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDonCall(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read___tempuri__AnDon(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

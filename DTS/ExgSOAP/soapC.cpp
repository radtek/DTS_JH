...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.64 2018-03-07 08:26:39 GMT")
...
{	(void)soap; /* appease -Wall -Werror */
	...
	case SOAP_TYPE__tempuri__AnDon:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDon*>(p->ptr), _tempuri__AnDon);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDon*>(p->ptr), _tempuri__AnDon);
		break;
	case SOAP_TYPE__tempuri__AnDonResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDonResponse*>(p->ptr), _tempuri__AnDonResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDonResponse*>(p->ptr), _tempuri__AnDonResponse);
		break;
	case SOAP_TYPE__tempuri__AnDonCall:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDonCall*>(p->ptr), _tempuri__AnDonCall);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDonCall*>(p->ptr), _tempuri__AnDonCall);
		break;
	case SOAP_TYPE__tempuri__AnDonCallResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDonCallResponse*>(p->ptr), _tempuri__AnDonCallResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDonCallResponse*>(p->ptr), _tempuri__AnDonCallResponse);
		break;
	case SOAP_TYPE__tempuri__AnDonTest:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDonTest*>(p->ptr), _tempuri__AnDonTest);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDonTest*>(p->ptr), _tempuri__AnDonTest);
		break;
	case SOAP_TYPE__tempuri__AnDonTestResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__AnDonTestResponse*>(p->ptr), _tempuri__AnDonTestResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__AnDonTestResponse*>(p->ptr), _tempuri__AnDonTestResponse);
		break;
	case SOAP_TYPE__tempuri__ItemsAdd:
		if (p->size < 0)
	...
	case SOAP_TYPE__tempuri__SetExMail:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__SetExMail*>(p->ptr), _tempuri__SetExMail);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__SetExMail*>(p->ptr), _tempuri__SetExMail);
		break;
	case SOAP_TYPE__tempuri__SetExMailResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<_tempuri__SetExMailResponse*>(p->ptr), _tempuri__SetExMailResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<_tempuri__SetExMailResponse*>(p->ptr), _tempuri__SetExMailResponse);
		break;
	case SOAP_TYPE__tempuri__GetDept:
		if (p->size < 0)
	...
	case SOAP_TYPE___tempuri__AnDon:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDon*>(p->ptr), struct __tempuri__AnDon);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDon*>(p->ptr), struct __tempuri__AnDon);
		break;
	case SOAP_TYPE___tempuri__AnDonCall:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDonCall*>(p->ptr), struct __tempuri__AnDonCall);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDonCall*>(p->ptr), struct __tempuri__AnDonCall);
		break;
	case SOAP_TYPE___tempuri__AnDonTest:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDonTest*>(p->ptr), struct __tempuri__AnDonTest);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDonTest*>(p->ptr), struct __tempuri__AnDonTest);
		break;
	case SOAP_TYPE___tempuri__ItemsAdd:
		if (p->size < 0)
	...
	case SOAP_TYPE___tempuri__SetExMail:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__SetExMail*>(p->ptr), struct __tempuri__SetExMail);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__SetExMail*>(p->ptr), struct __tempuri__SetExMail);
		break;
	case SOAP_TYPE___tempuri__GetDept:
		if (p->size < 0)
	...
	case SOAP_TYPE___tempuri__AnDon_:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDon_*>(p->ptr), struct __tempuri__AnDon_);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDon_*>(p->ptr), struct __tempuri__AnDon_);
		break;
	case SOAP_TYPE___tempuri__AnDonCall_:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDonCall_*>(p->ptr), struct __tempuri__AnDonCall_);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDonCall_*>(p->ptr), struct __tempuri__AnDonCall_);
		break;
	case SOAP_TYPE___tempuri__AnDonTest_:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__AnDonTest_*>(p->ptr), struct __tempuri__AnDonTest_);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__AnDonTest_*>(p->ptr), struct __tempuri__AnDonTest_);
		break;
	case SOAP_TYPE___tempuri__ItemsAdd_:
		if (p->size < 0)
	...
	case SOAP_TYPE___tempuri__SetExMail_:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct __tempuri__SetExMail_*>(p->ptr), struct __tempuri__SetExMail_);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct __tempuri__SetExMail_*>(p->ptr), struct __tempuri__SetExMail_);
		break;
	case SOAP_TYPE___tempuri__GetDept_:
		if (p->size < 0)
...
SOAP_FMAC1 _tempuri__SetExMailResponse * SOAP_FMAC2 soap_instantiate__tempuri__SetExMailResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__SetExMailResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__SetExMailResponse);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__SetExMailResponse, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__SetExMail * SOAP_FMAC2 soap_instantiate__tempuri__SetExMail(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__SetExMail, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__SetExMail);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__SetExMail, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDonTestResponse * SOAP_FMAC2 soap_instantiate__tempuri__AnDonTestResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDonTestResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDonTestResponse);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDonTestResponse, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDonTest * SOAP_FMAC2 soap_instantiate__tempuri__AnDonTest(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDonTest, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDonTest);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDonTest, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDonCallResponse * SOAP_FMAC2 soap_instantiate__tempuri__AnDonCallResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDonCallResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDonCallResponse);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDonCallResponse, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDonCall * SOAP_FMAC2 soap_instantiate__tempuri__AnDonCall(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDonCall, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDonCall);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDonCall, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDonResponse * SOAP_FMAC2 soap_instantiate__tempuri__AnDonResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDonResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDonResponse);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDonResponse, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 _tempuri__AnDon * SOAP_FMAC2 soap_instantiate__tempuri__AnDon(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__tempuri__AnDon, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, _tempuri__AnDon);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, _tempuri__AnDon, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
...
SOAP_FMAC1 struct __tempuri__SetExMail_ * SOAP_FMAC2 soap_instantiate___tempuri__SetExMail_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__SetExMail_, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__SetExMail_);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__SetExMail_, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDonTest_ * SOAP_FMAC2 soap_instantiate___tempuri__AnDonTest_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDonTest_, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDonTest_);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDonTest_, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDonCall_ * SOAP_FMAC2 soap_instantiate___tempuri__AnDonCall_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDonCall_, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDonCall_);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDonCall_, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDon_ * SOAP_FMAC2 soap_instantiate___tempuri__AnDon_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDon_, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDon_);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDon_, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__SetExMail * SOAP_FMAC2 soap_instantiate___tempuri__SetExMail(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__SetExMail, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__SetExMail);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__SetExMail, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDonTest * SOAP_FMAC2 soap_instantiate___tempuri__AnDonTest(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDonTest, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDonTest);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDonTest, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDonCall * SOAP_FMAC2 soap_instantiate___tempuri__AnDonCall(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDonCall, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDonCall);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDonCall, n);
		k *= n;
	}
...
SOAP_FMAC1 struct __tempuri__AnDon * SOAP_FMAC2 soap_instantiate___tempuri__AnDon(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE___tempuri__AnDon, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct __tempuri__AnDon);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct __tempuri__AnDon, n);
		k *= n;
	}

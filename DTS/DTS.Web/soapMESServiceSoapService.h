...
#include "soapH.h"
    ...
    class SOAP_CMAC MESServiceSoapService : public soap {
      public:
        ...
        virtual MESServiceSoapService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        ...
        virtual int AnDan1Send(_tempuri__AnDan1Send *tempuri__AnDan1Send, _tempuri__AnDan1SendResponse &tempuri__AnDan1SendResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan4UpdPeoplePresent' (returns SOAP_OK or error code)
        virtual int AnDan4UpdPeoplePresent(_tempuri__AnDan4UpdPeoplePresent *tempuri__AnDan4UpdPeoplePresent, _tempuri__AnDan4UpdPeoplePresentResponse &tempuri__AnDan4UpdPeoplePresentResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan3AddUsers' (returns SOAP_OK or error code)
        virtual int AnDan3AddUsers(_tempuri__AnDan3AddUsers *tempuri__AnDan3AddUsers, _tempuri__AnDan3AddUsersResponse &tempuri__AnDan3AddUsersResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan2PeoplePresent' (returns SOAP_OK or error code)
        virtual int AnDan2PeoplePresent(_tempuri__AnDan2PeoplePresent *tempuri__AnDan2PeoplePresent, _tempuri__AnDan2PeoplePresentResponse &tempuri__AnDan2PeoplePresentResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDanSLTypeGet' (returns SOAP_OK or error code)
        virtual int AnDanSLTypeGet(_tempuri__AnDanSLTypeGet *tempuri__AnDanSLTypeGet, _tempuri__AnDanSLTypeGetResponse &tempuri__AnDanSLTypeGetResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDanSLTypeAdd' (returns SOAP_OK or error code)
        virtual int AnDanSLTypeAdd(_tempuri__AnDanSLTypeAdd *tempuri__AnDanSLTypeAdd, _tempuri__AnDanSLTypeAddResponse &tempuri__AnDanSLTypeAddResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetDate' (returns SOAP_OK or error code)
        ...
        /// Web service operation 'AnDan1Send' (returns SOAP_OK or error code)
        virtual int AnDan1Send_(_tempuri__AnDan1Send *tempuri__AnDan1Send, _tempuri__AnDan1SendResponse &tempuri__AnDan1SendResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan4UpdPeoplePresent' (returns SOAP_OK or error code)
        virtual int AnDan4UpdPeoplePresent_(_tempuri__AnDan4UpdPeoplePresent *tempuri__AnDan4UpdPeoplePresent, _tempuri__AnDan4UpdPeoplePresentResponse &tempuri__AnDan4UpdPeoplePresentResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan3AddUsers' (returns SOAP_OK or error code)
        virtual int AnDan3AddUsers_(_tempuri__AnDan3AddUsers *tempuri__AnDan3AddUsers, _tempuri__AnDan3AddUsersResponse &tempuri__AnDan3AddUsersResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDan2PeoplePresent' (returns SOAP_OK or error code)
        virtual int AnDan2PeoplePresent_(_tempuri__AnDan2PeoplePresent *tempuri__AnDan2PeoplePresent, _tempuri__AnDan2PeoplePresentResponse &tempuri__AnDan2PeoplePresentResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDanSLTypeGet' (returns SOAP_OK or error code)
        virtual int AnDanSLTypeGet_(_tempuri__AnDanSLTypeGet *tempuri__AnDanSLTypeGet, _tempuri__AnDanSLTypeGetResponse &tempuri__AnDanSLTypeGetResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'AnDanSLTypeAdd' (returns SOAP_OK or error code)
        virtual int AnDanSLTypeAdd_(_tempuri__AnDanSLTypeAdd *tempuri__AnDanSLTypeAdd, _tempuri__AnDanSLTypeAddResponse &tempuri__AnDanSLTypeAddResponse) SOAP_PURE_VIRTUAL;
    };
#endif
